...
export function TaskCard({ title, timeOfDay, tasks, onAddTask, onToggleTask, onDeleteTask }: TaskCardProps) {
  ...
  return (
    ...
    >
      <Card className={cn(
        "relative overflow-hidden border border-border/40 shadow-gentle hover:shadow-elegant h-full flex flex-col",
        "transition-all duration-500 hover:scale-[1.02] backdrop-blur-sm animate-fade-in min-h-[500px]",
        theme.gradient
      )}>
        ...
        <CardContent className="relative flex-1 flex flex-col">
          ...
          <div className="pt-6">
            <Button
              ...
              variant="outline"
              className={cn(
                "w-full h-12 border-dashed border-2 font-medium",
