...
import { Check, Calendar, MoreVertical, Edit2, Trash2, Flame, Star } from 'lucide-react';
...
export const HabitCard = ({ habit, onViewCalendar }: HabitCardProps) => {
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div className="text-center">
              <div className="font-bold text-lg text-purple-600">{habit.bestStreak}</div>
