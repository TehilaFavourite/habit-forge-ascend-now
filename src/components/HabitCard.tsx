...
export const HabitCard = ({
  ...
  return (
    <Card className='group relative overflow-hidden h-full flex flex-col bg-gradient-subtle border border-border/40 shadow-gentle hover:shadow-glow transition-all duration-500 hover:scale-[1.02] backdrop-blur-sm animate-fade-in'>
      ...
      {/* Completion Celebration Effect - toned down */}
      {isCompletedToday && (
        <>
      ...
      <CardContent className='relative p-6 flex flex-col h-full'>
        ...
        <div className='flex items-start justify-between mb-6'>
          <div className='flex items-center gap-4'>
            ...
            <div className='relative'>
              ...
              {habit.currentStreak > 0 && (
                <div className='absolute -bottom-1 -right-1'>
                  <Flame className='w-5 h-5 text-primary/80' />
                </div>
              )}
            </div>
            ...
            <div className='space-y-3 flex-1'>
              ...
              <div className='flex items-center gap-2 flex-wrap'>
                <Badge
                  variant='secondary'
                  className='text-xs px-3 py-1 bg-secondary/80 hover:bg-secondary transition-colors'
                >
                  {habit.frequency}
                </Badge>
                {habit.isCore && (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align='end'
              className='w-48 shadow-glow border-border/50'
            >
              <DropdownMenuItem
        ...
        <Button
          ...
          className={`w-full h-14 transition-all duration-500 font-semibold text-base shadow-elegant hover:shadow-glow group/button ${
            isCompletedToday
              ? "bg-gradient-to-r from-success to-success-glow text-success-foreground"
          ...
          <div className='flex items-center justify-center gap-3'>
            <div
              className={`transition-all duration-300 ${
                isCompletedToday ? "" : "group-hover/button:scale-110"
              }`}
            >
